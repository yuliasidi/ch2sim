...
x1_m50 <- readRDS("results/mcar/mdsu_obs3_smcar_sc1_ms50.rds")

x1 <- readRDS("results/mcar/mdsu_obs3_smcar_sc1.rds")
...
saveRDS(check_mcar, "checks/ch_mcar_ms.rds")

###########################
## Same as above for MAR ##
###########################

x1_m50 <- readRDS("results/mar/mdsu_obs3_smar_sc1_ms50.rds")

x1 <- readRDS("results/mar/mdsu_obs3_smar_sc1.rds")
...
saveRDS(check_mar, "checks/ch_mar_ms.rds")
